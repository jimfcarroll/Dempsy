...
public abstract class PersistentTask implements ClusterInfoWatcher {
    ...
    public PersistentTask(final Logger logger, final AtomicBoolean isStillRunningFlag,
            final AutoDisposeSingleThreadScheduler autoDisposeSingleThreadScheduler, final long resetDelayMillis) {
        this.logger = logger;
